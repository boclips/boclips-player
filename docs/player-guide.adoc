...
Where appropriate we ask that you enrich these events with unique identifiers per user. This allows us to correlate
between events and identify trends between segments of users.
