...
You must pass a video URI endpoint to `Player.loadVideo`. See link:https://docs.boclips.com/docs/api-guide/index.html#resources-video-access[Video Access] for more information.
...
An example tokenFactory, using `boclips-js-security@3.2.2`:
```typescript
